# نظام إدارة Sharks Olympic Academy

هذا التطبيق هو نظام متكامل لإدارة Sharks Olympic Academy، مبني باستخدام React و Tailwind CSS. يتصل النظام بقاعدة بيانات Google Sheets عبر واجهة برمجة تطبيقات (API) مخصصة باستخدام تقنية JSONP لتجاوز قيود CORS.
