...
export const DEFAULT_COURSE_PRICES = {
  ...
  'دورات عادية مع مواصلات فوق ال ٥ سنوات (زبائن الصيف)': 700,
  'دورات عادية بدون مواصلات فوق ال ٥ سنوات (زبائن الصيف)': 500,
...
export const calculateMonthlyFee = (courseType: string, customPrices?: Record<string, number>) => {
  ...
  return prices[courseType] || Object.values(prices)[0] || 600;
};
