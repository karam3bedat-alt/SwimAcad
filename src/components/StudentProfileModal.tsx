...
export function StudentProfileModal({ isOpen, onClose, student }: StudentProfileModalProps) {
  ...
  const getSafeFormattedDate = (dateVal: any, formatStr: string = 'yyyy-MM-dd') => {
        ...
        return (
          <div className="space-y-6 font-['Cairo'] animate-in fade-in slide-in-from-bottom-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <InfoCard icon={Calendar} label="تاريخ التسجيل" value={getSafeFormattedDate(student.registration_date)} />
              ...
              {student.subscription_model === 'rolling' && (
                <InfoCard 
                  ...
                  value={getSafeFormattedDate(student.subscription_end_date)} 
                />
              )}
